...
| [async-all-around-creation](skills/async-all-around-creation/SKILL.md) | 异步全能创作，调用 Image-2 模型生成多张创意图片 |
...
### async-all-around-creation

异步全能创作，适用于根据提示词和可选参考图调用 Image-2 模型生成产品图或创意图片。
...
详细参数和轮询规则请查看 [skills/async-all-around-creation/SKILL.md](skills/async-all-around-creation/SKILL.md)。
